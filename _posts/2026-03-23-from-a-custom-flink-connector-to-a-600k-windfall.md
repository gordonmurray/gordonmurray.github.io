...
![Flink job running with 636K records processed]({{ site.url }}/images/flink_jobs.png)
...
![Live ticks dashboard showing BTC price, OHLCV candles, and message throughput]({{ site.url }}/images/live_ticks.png)
...
![Grafana dashboard with LLM annotation showing sentiment analysis]({{ site.url }}/images/live_tick_llm_annotation.png)
...
![Paper trading dashboard showing equity curve, positions, and P&L]({{ site.url }}/images/paper_trading.png)
